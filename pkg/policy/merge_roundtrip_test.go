...
func TestMergeAfterYAMLRoundtrip_EndpointRules(t *testing.T) {
	...
	original := policy.BuildPolicy("default", "server", []*flowpb.Flow{flows})
	...
	incoming := policy.BuildPolicy("default", "server", []*flowpb.Flow{flows})
...
func TestMergeAfterYAMLRoundtrip_MultipleRules(t *testing.T) {
	...
	original := policy.BuildPolicy("default", "server", flows1)
	originalYAML, err := yaml.Marshal(original)
	require.NoError(t, err)
	t.Logf("Original YAML:\n%s", originalYAML)
	...
	// Flush 2: same flows
	incoming := policy.BuildPolicy("default", "server", flows1)
...
func TestMergeAfterYAMLRoundtrip_ThreeFlushCycles(t *testing.T) {
	...
	policy1 := policy.BuildPolicy("default", "server", flush1)
	...
	policy2 := policy.BuildPolicy("default", "server", flush2)
	...
	policy3 := policy.BuildPolicy("default", "server", flush3)
...
func TestMergeAfterYAMLRoundtrip_EgressCIDR(t *testing.T) {
	...
	original := policy.BuildPolicy("default", "client", flows)
	originalYAML, err := yaml.Marshal(original)
	require.NoError(t, err)
	t.Logf("Original YAML:\n%s", originalYAML)
	...
	incoming := policy.BuildPolicy("default", "client", flows)
	merged := policy.MergePolicy(&fromDisk, incoming)
	mergedYAML, err := yaml.Marshal(merged)
	require.NoError(t, err)
	t.Logf("Merged YAML:\n%s", mergedYAML)
